...
function formatDelta(value: number, prefix = "+") {
  return `${prefix}${value}`;
}
...
export default function OverviewSection({ setActiveSection }: Props) {
  ...
  const handleAlertAction = (actionType: "detail" | "opportunity" | "analysis") => {
          ...
          <div className="chart-card overview-alert-card-v2">
            ...
            <div className="overview-alert-list-v2">
              {data.alerts.map((alert, idx) => {
                ...
                const actionType = resolveActionType(alert.title, alert.subtitle);
                  ...
                  >
                    ...
                    <div className="overview-alert-right-v2">
                      ...
                      <button
                        ...
                        onClick={() => handleAlertAction(actionType)}
                      >
                        {buttonLabel}
                      </button>
                    </div>
